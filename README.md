# ODOO - ReWear(Swapify) - Item Swap & Sale Platform
...
Video Link : https://youtu.be/gXX8h-TLahU?si=8V2fxPqV_NUK-16q
...
- **Lokesh Chaurasia** - Backend Development, API Design, Business Logic
- **Joy Patel** - Backend Development, Database Architecture, Data Modeling
- **Ashutosh Chudasama** - Project Management, Frontend Development, Team Leadership
- **Naresh Prajapati** - Frontend Development, UI/UX Design, Media Management
